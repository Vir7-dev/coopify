    ...
    <AppLayout role="admin">
      <div className="w-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          <div className="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3 w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm text-left">
              ...
              <tbody>
                {currentItems.map((item, i) => (
                  <tr key={i} className="hover:bg-gray-50">
                    <td className="px-4 py-3 text-gray-400">{indexOfFirstItem + i + 1}</td>
                    ...
                    <td className="border-b border-gray-200 px-4 py-3">
                      <span className={`px-3 py-1 rounded-full text-xs ${item.stok <= 5 ? "bg-red-100 text-orange-600" : "bg-green-100 text-green-600"}`}>
                        {item.stok} produk
                      </span>
                    </td>
                    <td className="border-b border-gray-200 px-4 py-3 text-gray-500">
                      ...
                      <p className="text-xs text-gray-400">10:30 WIB</p>
                    </td>
                    <td className="border-b border-gray-200 px-4 py-3">
                      <div className="flex gap-2">
                        <button onClick={() => handleEdit(item)} className="border border-blue-500 text-blue-500 px-3 py-1 rounded-md text-xs hover:bg-blue-50 flex items-center gap-1">
                          <FaEdit size={10} /> Edit
                        </button>
                        <button onClick={() => handleDeleteClick(item)} className="border border-red-400 text-red-500 px-3 py-1 rounded-md text-xs hover:bg-red-50 flex items-center gap-1">
          ...
          <div className="flex justify-between items-center p-4 text-sm text-gray-500">
            <p>Menampilkan {currentItems.length} dari {products.length} kategori</p>
